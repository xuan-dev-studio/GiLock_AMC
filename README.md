...
1.在篡改猴安装本插件后先进入编辑页面修改脚本内顶部match区域信息（默认为http://192.168.1.1:9300/）为项目实际使用的平台内网IP和端口号并保存
2.打开并刷新项目GiLock制卡页面即可在平台网页右上角点击本插件提供的额外按钮功能
3.脚本插件运行时可在浏览器F12开发者模式的控制台中实时监控查看脚本命令执行状态
